                    ...
                    <form class="needs-validation"
                        ...
                        <div class="form-group">
                            <label class="form-label"
                                   for="basic-addon-name">Name</label>
                        ...
                        <div class="form-group">
                            <label class="form-label"
                                   for="basic-default-email1">Email</label>
                            <input type="email"
                        ...
                        <div class="form-group">
                            <label class="form-label"
                                   for="basic-default-password1">Password</label>
                            <input type="password"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text"
                                   class="form-control flatpickr-validation flatpickr"
                        ...
                        <div class="form-group">
                            ...
                            <div class="custom-file">
                                ...
                                <label class="custom-file-label"
                                       for="customFile1">Choose profile pic</label>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="custom-control custom-radio my-50">
                                ...
                                <label class="custom-control-label"
                                       for="validationRadio3">Male</label>
                            </div>
                            <div class="custom-control custom-radio">
                                <input type="radio"
                                       ...
                                       required />
                                <label class="custom-control-label"
                                       for="validationRadio4">Female</label>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="d-block"
                                   for="validationBioBootstrap">Bio</label>
                        ...
                        <div class="form-group">
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox"
                                       ...
                                       required />
                                <label class="custom-control-label"
                                       for="validationCheckBootstrap">Agree to our terms and conditions</label>
