...
class LocationsController extends Controller
{
  ...
  public function index()
  {
    ...
    public function get_thana_by_city(Request $request)
    {
        $cityId = $request->cityId;

        $thanas = Thana::where('city_id', $cityId)->get();


        return $thanas;
    }
    public function get_area_by_thana(Request $request)
    {
        $thanaId = $request->thanaId;

        $areas = Area::where('thana_id', $thanaId)->get();
